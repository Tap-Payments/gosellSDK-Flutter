...
public class GoSellSdkFlutterPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        ...
        channel = new MethodChannel(binding.getBinaryMessenger(), "go_sell_sdk_flutter");
    ...
    private static class MethodResultWrapper implements MethodChannel.Result {
        ...
        @Override public void success(final Object result) { handler.post(() -> methodResult.success(result)); }
        @Override public void error(final String errorCode, final String errorMessage, final Object errorDetails) {
            handler.post(() -> methodResult.error(errorCode, errorMessage, errorDetails));
        }
        @Override public void notImplemented() { handler.post(methodResult::notImplemented); }
    }
